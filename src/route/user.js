...
const { addNotes, getNotes, viewNote, updateNote, deleteNote, findNotes, getBackupNotes } = require('../controller/user/notes')
const { registerUser, loginUser, delteUser, getUserAllUser } = require('../controller/user/auth')
const { authmidleware } = require('../middleware/auth_middelware')
const { draftData, draftDataGet, deleteDraft } = require('../controller/user/draft')
const { addMessage, getAllUserChatName, getAllMessage } = require('../controller/user/chat')
